...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ct", required=True, help="与手工分割对齐的 CT NIfTI/NRRD")
    ...
    parser.add_argument("--registration-module", required=True, help="下游检索模块 2021.py")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        summary = write_manual_segmentation_case(
            ...
            registration_module_path=args.registration_module,
